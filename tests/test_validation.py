...
class TestBootstrap:
    ...
    def test_bootstrap_test_run(self):
        ...
        test = BootstrapTest(self.r_multiples, n_iterations=100, random_seed=self.random_seed)
        results = test.run()
    ...
    def test_check_bootstrap_results_pass(self):
        ...
        results = {"sharpe_5th": 0.5, "max_dd_95th": 0.20, "sharpe_percentile_rank": 50.0}
    ...
    def test_check_bootstrap_results_fail(self):
        ...
        results = {"sharpe_5th": 0.3, "max_dd_95th": 0.20, "sharpe_percentile_rank": 50.0}  # Below threshold
        passed, warnings = check_bootstrap_results(results)
        assert not passed
    ...
    def test_run_bootstrap_test(self):
        ...
        results = run_bootstrap_test(self.r_multiples, n_iterations=100, random_seed=self.random_seed)
        assert "sharpe_5th" in results
...
class TestSensitivity:
    ...
    def setup_method(self):
        """Set up test fixtures."""
        self.parameter_ranges = {"atr_mult": [2.0, 2.5, 3.0], "clearance": [0.005, 0.010]}
        self.random_seed = 42
...
class TestPermutation:
    ...
    def test_permutation_test_run(self):
        ...
        test = PermutationTest(
            self.actual_trades, self.period, self.compute_sharpe_func, n_iterations=100, random_seed=self.random_seed
        )
        results = test.run()
    ...
    def test_check_permutation_results_pass(self):
        ...
        results = {"actual_sharpe": 2.0, "random_sharpe_95th": 1.5, "percentile_rank": 96.0, "passed": True}
    ...
    def test_check_permutation_results_fail(self):
        ...
        results = {"actual_sharpe": 1.0, "random_sharpe_95th": 1.5, "percentile_rank": 90.0, "passed": False}
        passed, warnings = check_permutation_results(results)
        assert not passed
...
class TestCorrelationAnalysis:
    ...
    def setup_method(self):
        ...
        for i, date in enumerate(dates):
            ...
            self.portfolio_history[date] = {"equity": equity, "positions": positions}

    def test_correlation_stress_analysis(self):
        """Test correlation stress analysis."""
        analysis = CorrelationStressAnalysis(self.portfolio_history, self.returns_data, lookback=20)
    ...
    def test_check_correlation_warnings(self):
        ...
        results = {"drawdown_avg_corr": 0.75, "correlation_increase": 0.25, "warning": True}  # Above threshold
