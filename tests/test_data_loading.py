...
class TestLoadOHLCVData:
    ...
    def test_date_filtering(self):
        ...
        data = load_ohlcv_data(FIXTURES_DIR, ["AAPL"], start_date=start_date, end_date=end_date)
...
class TestDetectMissingData:
    ...
    def test_single_missing_day(self):
        ...
        dates = pd.DatetimeIndex(["2023-01-01", "2023-01-03", "2023-01-04"])
        df = pd.DataFrame(
            {
                "open": [100.0, 101.0, 102.0],
                "high": [102.0, 103.0, 104.0],
    ...
    def test_consecutive_missing_days(self):
        ...
        dates = pd.DatetimeIndex(["2023-01-01", "2023-01-05"])  # Missing 3 days
        df = pd.DataFrame(
            {
                "open": [100.0, 104.0],
                "high": [102.0, 106.0],
...
class TestLoadBenchmark:
    ...
    def test_benchmark_date_filtering(self):
        ...
        with pytest.raises(ValueError, match="insufficient data"):
            load_benchmark("SPY", FIXTURES_DIR, start_date=start_date, end_date=end_date)
