...
def example_train_ml_model():
    ...
    _ = runner.run_backtest(period="train")
...
def example_load_and_use_model():
    ...
    feature_engineer = MLFeatureEngineer(
        include_technical_indicators=True, include_price_features=True, include_volume_features=True, normalize=True
    )
...
def example_model_versioning():
    ...
    model_info = {
        ...
        "performance_metrics": {"train_r2": 0.75, "validation_r2": 0.70},
    }
