...
class StrategyInterface(ABC):
    ...
    def check_capacity(self, order_notional: float, adv20: float) -> bool:
    ...
    def calculate_breakout_strength(self, close: float, ma: float, atr14: float) -> float:
    ...
    def calculate_momentum_strength(self, roc60: Optional[float], benchmark_roc60: Optional[float]) -> float:
