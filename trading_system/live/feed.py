    ...
    def _update_features(self, symbol: str) -> None:
        ...
        try:
            features_df = compute_features(
                ...
                use_cache=False,  # Don't cache in real-time
            ...
            for symbol in strategy.universe:
                ...
                try:
                    feature_row = FeatureRow(
                        ...
                        highest_close_20d=float(latest_features['highest_close_20d']) if pd.notna(latest_features['highest_close_20d']) else None,
                        highest_close_55d=float(latest_features['highest_close_55d']) if pd.notna(latest_features['highest_close_55d']) else None,
                        ...
                        benchmark_roc60=float(latest_features['benchmark_roc60']) if pd.notna(latest_features['benchmark_roc60']) else None,
                        benchmark_returns_1d=float(latest_features['benchmark_returns_1d']) if pd.notna(latest_features['benchmark_returns_1d']) else None
                    )
                except Exception as e:
